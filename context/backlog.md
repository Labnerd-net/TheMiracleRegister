...
- **#44 [src/pages/miracles/[slug].astro]** Lightbox for miracle images — clicking any image (sidebar or gallery) opens a full-size overlay with caption and attribution. No JS framework needed; a minimal vanilla implementation with a `<dialog>` element and `showModal()` is sufficient.
