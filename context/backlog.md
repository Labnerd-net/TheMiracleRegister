...
- **#46 [src/pages/feast-days.astro]** Feast day list page — all 366 days of the year as a scrollable list, populated from `src/data/feastDays.ts`. Each day shows feast name(s); days where we have a published saint become links to our saint page. Skipped in favor of the calendar grid (#45, done) — revisit if a flat list is preferable for mobile or SEO.
